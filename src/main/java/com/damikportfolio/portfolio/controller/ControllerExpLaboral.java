...
public class ControllerExpLaboral {
    ...
    @PutMapping ("/actualizar/expLaboral/{id}")
    public void actualizarExpLaboral (@RequestBody ExpLaboral expLab, @PathVariable Long id){
        this.expLabServ.actualizarExpLaboral(expLab, id);
    }
